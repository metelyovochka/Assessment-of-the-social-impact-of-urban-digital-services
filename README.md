...
Метод был апробирован как на муляжынх, так и на реальных данных; проведены экспериментальные исследования метода:

- применение метода на примере муляжного городского цифрового сервиса «Гимназии Петербурга» (социологические данные были сгенерированы), оценка социальной результативности 
